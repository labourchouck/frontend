    ...
    async function fetchPolicy() {
      try {
        ...
        const res = await apiClient.get('/privacy-policy', {
          params: { role: 'contractor' } // Vendor terms map to 'contractor' role in backend
        })
  ...
  return (
    <div className="w-full space-y-5 pb-28">
      <div>
        ...
        <h1 className="mt-0.5 text-xl font-black tracking-tight text-slate-900">Privacy Policy</h1>
        <p className="mt-1 text-sm text-slate-600">
          Review the privacy policy and data handling practices for vendor accounts.
        </p>
      </div>
