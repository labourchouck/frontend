...
export function CorporateSubscriptionModal({ isOpen, onClose, onSave, mode = 'create', initialData = null }) {
      ...
      >
        ...
        >
          ...
          <h2 className="mb-6 text-2xl font-bold text-slate-800">
            {mode === 'create' ? 'Add Corporate Plan' : mode === 'edit' ? 'Edit Corporate Plan' : 'View Corporate Plan'}
          </h2>
