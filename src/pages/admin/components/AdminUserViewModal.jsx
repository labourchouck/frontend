                ...
                <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <p className={`font-bold ${user.contractorProfile.verificationStatus === 'approved' ? 'text-emerald-600' : 'text-amber-600'}`}>
              ...
              {user.role === 'labour' && user.labourProfile && (
                <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                    <div>
                      <p className="text-xs font-bold uppercase tracking-wide text-slate-400">KYC Status</p>
                      <p className={`font-bold ${user.labourProfile.kycStatus === 'verified' ? 'text-emerald-600' : 'text-amber-600'}`}>
