        ...
        <div className="p-5 space-y-6">
          ...
          <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
            ...
            <div className="grid grid-cols-2 gap-y-4 gap-x-2 text-sm">
              <div>
                <p className="text-[10px] uppercase text-slate-400 font-bold mb-1">Corporate Client</p>
                <p className="font-semibold text-slate-800 line-clamp-1">{request.clientId?.corporateProfile?.companyName || request.clientId?.fullName}</p>
              </div>
